...
public class MainActivity extends AppCompatActivity {
    ...
    private RadioButton mMenitRadido;
    ...
    protected void onCreate(Bundle savedInstancestate) {
        ...
        mMenitRadido = (RadioButton) findViewById(R.id.radio0);
        ...
        mSetBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mMenitRadido.getId() == mRadioID) {
                    mChangeTime = 60;
                ...
                /*nembuat bundle dan nenyimpan pasangan nilai dengan kuncinya */
